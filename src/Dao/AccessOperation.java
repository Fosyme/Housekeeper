...
public class AccessOperation {
     ...
     * 查询数据, 返回数据集
     */
    public static ResultSet query(String table, String id) {
    ...
    public static String loginAuthentication(String userName, String userPassword) {
        String ID = null;
        ID = MethodOfOperation.loginAuthentications(userName, userPassword);
        return ID;
    }
    ...
    public static boolean checkUserExist(String userName) {
        return MethodOfOperation.CheckUserExists(userName);
    }
}
